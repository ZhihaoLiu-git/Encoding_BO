...
from Encoding_BO.experiment.run_experiments.CoCaBO.methods.CoCaBO_Base import CoCaBO_Base
...
class CoCaBO(CoCaBO_Base):
    ...
    def RewardperCategoryviaBO(self, objfn, ht_next_list, categorical_dims,
                               continuous_dims, bounds, acq_type, b, t):
        ...
        beta = get_beta(iteration=t, dim=len(bounds))
        if acq_type == 'EI':
